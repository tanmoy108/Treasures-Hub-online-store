...
import { selectSpecificProduct, specificProductAsync } from '../../productList/ProductSlice'
...
export default function AdminSpecificProduct() {
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <div className="mt-6">
              ...
              <div className="flex items-center">
                ...
                <p className='ml-2 text-yellow-500 font-bold' >{product.rating}</p>
