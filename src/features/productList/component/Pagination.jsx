        ...
        <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
          <div>
            <p className="text-sm text-gray-700">
              Showing <span className="font-medium">{(page - 1) * ITEMS_IN_PAGE + 1}</span> to <span className="font-medium">{page * ITEMS_IN_PAGE > totalItems ? totalItems : page * ITEMS_IN_PAGE}</span> of{' '}
          ...
          <div>
            <nav className="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
              ...
              {Array.from({ length: Math.ceil(totalItems / ITEMS_IN_PAGE) }).map((item, index) =>
                <div
