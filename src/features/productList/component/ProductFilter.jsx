...
import { filterproductAsync } from '../ProductSlice'
...
const ProductListFilter = () => {
  ...
  // const HandleSelect = (e, section, option) => {
  //   console.log({ e, section, option })
  //   let obj = { ...filterSelect };

  //   if (e.target.checked) {
  //     if (section.id === "category") {
  //       obj[section.id] = [...dataCategory, option.value];
  //       setDataCategory(obj[section.id])
  //     }
  //     else {
  //       obj[section.id] = [...dataBrand, option.value];
  //       setDataBrand(obj[section.id])
  //     }
  //   }
  //   else {
  //     const index = obj[section.id].findIndex(i => i === option.value)
  //     obj[section.id].splice(index, 1)
  //     console.log({ obj })
  //   }
  //   setFilterSelect(obj)
  //   dispatch(filterproductAsync(obj))
  // }
  ...
  const HandleSelect = (e, section, option) => {
    ...
    if (e.target.checked) {
      if (obj[section.id]) {
        obj[section.id].push(option.value)
      }
      else obj[section.id] = [option.value]
    }
    else {
      const index = obj[section.id].findIndex(i => i === option.value)
      obj[section.id].splice(index, 1)
                                ...
                                {section.options.map((option, optionIdx) => (
                                  <div key={option.value} className="flex items-center">
                                    <input
                                      ...
                                      onChange={(e) => HandleSelect(e, section, option)}
